...
- (void)viewDidLoad {
    ...
    NSDate *postedAgoDate = [NSDate dateWithTimeIntervalSinceNow:self.post.createdAt.timeIntervalSinceNow];
    self.timeAgoLabel.text = [NSString stringWithFormat:@"%@", postedAgoDate.shortTimeAgoSinceNow];
